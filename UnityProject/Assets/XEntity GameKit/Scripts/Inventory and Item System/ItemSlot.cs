...
namespace XEntity.InventoryItemSystem
{
    ...
    public class ItemSlot : MonoBehaviour
    {
        ...
        public void RemoveAndDrop(int amount, Vector3 unusedDropPosition)
        {
            Transform cameraTransform = Camera.main.transform;
            Vector3 dropPosition = cameraTransform.position + cameraTransform.forward * 1.5f + Vector3.up * 0.5f;
